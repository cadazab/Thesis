...
En esta teoria, el photon offer a whole new perspective on electromagnetic interactions, the electrical repulsion or atraction no se atribuye mas al campo magnetic, in the quantum field theory the electric field is quantized in the form of photons, and the electric interactions are described as 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg0NTE2OTQ2MSwtMjA3NjA1NzA0NywxMj
